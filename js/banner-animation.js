...
THREE.SpriteCanvasMaterial = function(parameters) {
    ...
    this.color = new THREE.Color(0x292929);
...
jQuery(function($) {
    ...
    if ($('#home_wave').length > 0) {
        ...
        var windowFullY = window.innerHeight;
    ...
    function init() {
        ...
        scene.fog = new THREE.Fog(0x292929, 2000, 10000);

        particles = new Array();

        var geometry = new THREE.BoxGeometry(499, 20000);
        var material = new THREE.MeshBasicMaterial({ color: 0xff6304, transparent:true, opacity:.89});
        var cube = new THREE.Mesh(geometry, material);
            cube.position.setX(-250); 
        scene.add(cube);
